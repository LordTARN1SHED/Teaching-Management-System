...
<body style=font-family:华文新魏>
	<h1 class="H" align="center">教师管理系统</h1>
	...
	<table class="center" border="1" bgcolor="#ffffff" align="center" width="500">
		...
		<tr>
			...
			<td><?php
				...
				echo $_SESSION["uname"];
				?></td>
			<td style="text-align:center;background-color: darkgray;"><b>教师号</b></td>
			<td><?php
				session_start();
		...
		<tr>
			...
			<td style="text-align:center;background-color: darkgray;" colspan="3"><b>入职年份</b></td>
